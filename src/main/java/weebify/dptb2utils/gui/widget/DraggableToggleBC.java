...
public class DraggableToggleBC extends ClickableWidget {
    ...
    public void updatePosition() {
        ...
        this.setX((int) (client.getWindow().getScaledWidth() * mod.getFloatConfig("toggleBC.posX")));
        this.setY((int) (client.getWindow().getScaledHeight() * mod.getFloatConfig("toggleBC.posY")));
    }
    ...
    public boolean mouseDragged(double mouseX, double mouseY, int button, double dx, double dy) {
        if (this.dragging) {
            ...
            mod.setFloatConfig("toggleBC.posX", (float) getX() / sw);
            mod.setFloatConfig("toggleBC.posY", (float) getY() / sh);
            return true;
        }
        return false;
    }
